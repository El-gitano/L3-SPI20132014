...
static void
exo1_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	union {
...
main (int argc, char **argv)
{
	...
	if (!svc_register(transp, EXO1, EXO1VERS, exo1_1, IPPROTO_UDP)) {
		fprintf (stderr, "%s", "unable to register (EXO1, EXO1VERS, udp).");
		exit(1);
	}
	...
	if (!svc_register(transp, EXO1, EXO1VERS, exo1_1, IPPROTO_TCP)) {
		fprintf (stderr, "%s", "unable to register (EXO1, EXO1VERS, tcp).");
		exit(1);
	}

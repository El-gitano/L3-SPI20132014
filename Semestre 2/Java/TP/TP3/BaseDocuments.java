...
{ 
    ...
    */ 
    ...
    public Iterator selectionne(Selectionneur s){
    		...
    		List resultats = new LinkedList();
    		Iterator it = base.iterator();
		Document docTemp;
		
    		while(it.hasNext()){

			docTemp = (Document) it.next();
    			
    			if(s.estSatisfaitPar(docTemp)){

    				resultats.add(docTemp);
    			}
    		}
    ...
    public ArrayList listeTriee(Iterator i, Comparator c){

		ArrayList resultat = new ArrayList();

		//Ajout des éléments de l'itérateur
		while(i.hasNext()){
